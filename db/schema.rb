...
ActiveRecord::Schema.define(version: 2022_06_27_090926) do
  ...
  create_table "buy_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_buy_addresses_on_purchase_history_id"
  end
  ...
  add_foreign_key "buy_addresses", "purchase_histories"
